...
\includegraphics<5>[width=0.7\textwidth,page=5]{bcp_init}%
\includegraphics<6>[width=0.7\textwidth,page=6]{bcp_init}%
\includegraphics<7->[width=0.7\textwidth,page=7]{bcp_init}%
\end{center}
\end{figure}
\begin{itemize}
...
\item<9-> Persistence?
\vspace{10pt}
\item<10-> Construct once in $O(n\polylog n)$, then spend $O(k\polylog n)$ to rewind and generate the next BCP.
\end{itemize}
\end{frame}
